...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/28 17:06:48 by akezanna          #+#    #+#             */
/*   Updated: 2020/01/28 18:30:04 by akezanna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void		parse_print_int(t_specs *specs,
...
static int		print_x_with_nofg(t_specs *specs,
		t_parseprint *parseprint, char *hex)
{
	int len;
